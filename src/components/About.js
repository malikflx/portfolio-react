          ...
          <section id="about">
            <div className="full-width">
              <div className="intro small">
                ...
                <p className="about-me">Born in Brooklyn, NY and currently residing in Norwalk, CT, I'm a husband as well as a father of a beautiful young girl. I've been in Tech for almost 8 years in the IT Service Management/Infrastructre space.</p><br />
                <p className="about-me">See, here's the thing...I'm not your average tech guy. I didn't grow up wanting to do anything with technology outside of using it. I didn't want to <strong>build things</strong>, <strong>design websites</strong>, create logos, support enterprise technologhy infrastructure, or choose technology as a career profession. Now, I do all of those things.</p><br />
                <p>By day, I help a New York PR firm keep their technology infrastructure going without a hitch. By night, I <strong>design and develop websites</strong>. While I do know some <strong>back-end technologies</strong>, I focus on the <strong>front-end</strong> to leave your webpages <strong>beautiful</strong>, <strong>clean</strong>, and <strong>enticing</strong>.</p>
              </div>
              <div className="full-width">
